        ...
        <div className="h-[calc(100vh-6rem)] flex flex-col bg-gray-50 p-6 overflow-hidden w-full max-w-full">
            ...
            <div className="flex justify-between items-center mb-6 shrink-0">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={() => alert('Para adicionar manualmente, use a LP por enquanto (simulação)')}
            ...
            <div className="flex-1 overflow-hidden w-full min-w-0 flex flex-col">
                {loading ? (
                    ...
                    <div className="flex gap-4 h-full min-w-[1200px] overflow-x-auto overflow-y-hidden pb-4">
                        {COLUMNS.map(col => (
                            <div
                                key={col.id}
