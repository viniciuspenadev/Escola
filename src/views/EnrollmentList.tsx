    ...
    return (
        <div className="space-y-6 animate-fade-in pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Gestão de Matrículas</h1>
                    <p className="text-sm text-gray-500">Painel de controle de admissões e renovações.</p>
                </div>
