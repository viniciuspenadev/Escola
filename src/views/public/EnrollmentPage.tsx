            ...
            <div className="min-h-[60vh] flex flex-col items-center justify-center p-4">
                <div className="bg-green-50 p-8 rounded-2xl flex flex-col items-center text-center max-w-md w-full animate-fade-in border border-green-100 shadow-sm">
                    ...
                    <p className="text-gray-600 mb-6">
                        Recebemos seus dados com sucesso. Nossa equipe entrará em contato em breve para dar andamento à matrícula.
                    </p>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <section className="space-y-6">
                        ...
                        {children.map((child, index) => (
                            <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 relative">
                                {children.length > 1 && (
                                    <button
                                        type="button"
