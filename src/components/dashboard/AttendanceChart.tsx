    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm h-full flex flex-col justify-between">
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Presença Hoje</h3>
                    <p className="text-xs text-gray-400">Geral da escola</p>
                </div>
            ...
            <div className="flex items-end gap-2 mb-2">
                ...
                <span className="text-sm text-gray-500 mb-1">presentes</span>
            </div>
