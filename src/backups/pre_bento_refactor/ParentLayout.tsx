...
export const ParentLayout: FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col max-w-md mx-auto shadow-2xl overflow-hidden relative">
            ...
            <nav className="fixed bottom-0 w-full max-w-md bg-white/90 backdrop-blur-xl border-t border-gray-200/50 pb-safe-area z-30 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`p-1.5 rounded-xl transition-all ${active ? 'bg-brand-50/50 -translate-y-1' : 'bg-transparent'}`}>
